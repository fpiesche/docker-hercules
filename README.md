...
<!-- markdownlint-disable-next-line line_length html -->
<img style="float: right;" src="https://raw.githubusercontent.com/fpiesche/hercules-docker/master/hercules-icon.png" alt="Hercules logo"/>
...
`docker build --target export_build --output type=tar,dest=hercules.tar` will
build Hercules and save the finished build in the `hercules.tar` archive in your
current directory.
...
[automated builds](https://github.com/fpiesche/hercules-docker/actions) that
will match new Hercules releases.
